...
true_pos_LLNEUP12 <- nrow(filter(Household_data_12_trim, rdtrslt == 1 & BSdich == 1))
false_pos_LLNEUP12 <-nrow(filter(Household_data_12_trim, rdtrslt == 1 & BSdich == 0))
false_neg_LLNEUP12 <-nrow(filter(Household_data_12_trim, rdtrslt == 0 & BSdich == 1))
true_neg_LLNEUP12 <- nrow(filter(Household_data_12_trim, rdtrslt == 0 & BSdich == 0))

positives_by_rdt_LLN12 <- filter(Household_data_12_trim, rdtrslt == 1 )
 

# Calculate sensitivity
  # create a matrix to display these data
input_values_1 <- c(true_pos_LLNEUP12, false_pos_LLNEUP12, false_neg_LLNEUP12,true_neg_LLNEUP12 )
