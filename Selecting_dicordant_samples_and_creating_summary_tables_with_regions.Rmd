...
Household_data_12 <- Household_data_12 %>% 
  mutate(rdtdone = factor(case_when(
                  rdtdone == "No" ~ 0,
                  rdtdone == "Yes" ~ 1,
                  rdtdone == "-9" ~ as.numeric(rdtdone))),
...
paste0("RDT and BS was performed on ", RDT_and_bs_done_12_24, " samples from LLN12 and LLN24 studies") # 9355
```
