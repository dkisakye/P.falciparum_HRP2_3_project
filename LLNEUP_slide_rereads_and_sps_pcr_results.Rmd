...
var_ATS_data <- var_ATS_data %>% 
  transmute(`Sample Name`, Quantity_by_qpcr = round(qpcr, 0),
            `Study Subject`)
...
# Study subject name for 4064903947 is missing. This is because the merging with varATS data was done with only samples for which slide re-reads were performed. This sample was not part of those. Let me add study subject manually
